...
const { getRecord, createRecord, getSingleRecord, updateRecord, deleteRecord, forgetPassword1, forgetPassword2, forgetPassword3, login } = require("../Controller/UserController")
